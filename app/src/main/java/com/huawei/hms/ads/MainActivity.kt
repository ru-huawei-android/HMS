...
class MainActivity : AppCompatActivity(R.layout.activity_main) {
    ...
    var dataset: List<AdFormat> = listOf(
            AdFormat("Banner Ad", BannerActivity::class.java),
            AdFormat("Interstitial Ad", InterstitialActivity::class.java),
            AdFormat("Native Ad", NativeActivity::class.java),
            AdFormat("Reward Ad", RewardActivity::class.java)
    ...
    private fun checkConsentStatus() {
        ...
        consentInfo.requestConsentUpdate(object : ConsentUpdateListener {
            ...
            override fun onFail(errorDescription: String) {
                ...
                if (getPreferences(SP_CONSENT_KEY, DEFAULT_SP_CONSENT_VALUE) < 0) {
