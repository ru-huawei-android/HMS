 ...
 *
 * <p>You can get a instance of {@link com.huawei.hms.sample2.messaging.HuaweiMessaging}
 * by a instance of {@link com.huawei.hms.sample2.messaging.HuaweiApp}, and then use it to send a message
 */
public class HuaweiMessaging {
     ...
     * HCM performs all the necessary validations, and emulates the send operation.
     *
     * @param jsonString      message {@link Message} to be sent.
     * @param validateOnly a boolean indicating whether to send message for test or not.
     * @return {@link SendResponse}.
     * @throws HuaweiMesssagingException exception.
     */
    public SendResponse sendMessage(String jsonString, boolean validateOnly) throws HuaweiMesssagingException {
        ValidatorUtils.checkArgument(jsonString != null, "message must not be null");
        final HuaweiMessageClient messagingClient = getMessagingClient();
        return messagingClient.send(jsonString, validateOnly, ImplHuaweiTrampolines.getAccessToken(app));
    }
